...
//        $module = $this->ask('Enter a module which controller do you want to create)', "admin");
//        return $this->laravel->basePath().DIRECTORY_SEPARATOR.'module'.DIRECTORY_SEPARATOR."admin".DIRECTORY_SEPARATOR.'Controllers';
    ...
    public function handle()
    {
        ...
        $module = $this->ask('Enter Module:', 'Admin');
        ...
        $model = $this->ask('Can create model?', 'yes');
        if ($model == 'yes') {
            $table = Str::plural(strtolower($this->classname));
